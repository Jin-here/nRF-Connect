...
/**
 * 注：Tab是默认填充满宽度，因为layout_weight=1.
 */
...
public class SlidingTabStrip extends LinearLayout {
    ...
    private static final int DEFAULT_START_END_PADDING = 10;
    ...
    public SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        setPadding((int) (DEFAULT_START_END_PADDING * density), 0, (int) (DEFAULT_START_END_PADDING * density), 0);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link SlidingTabStrip} you are
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1f);
